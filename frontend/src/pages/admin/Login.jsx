...
export default function Login() {
  ...
  console.log("📢 FRONTEND IS TRYING TO CONNECT TO:", import.meta.env.VITE_API_URL); 
  ...
  async function handleLogin(e) {
    ...
    try {
      ...
      if (!err.response) {
        setError("Network Error. Check console for URL mismatch.");
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-rose-50 via-white to-blue-50 px-4 relative overflow-hidden">
      ...
      >
        <div className="text-center mb-10">
          ...
          <p className="mt-2 text-gray-500 text-sm">Enter your credentials to access the workspace.</p>
        </div>
